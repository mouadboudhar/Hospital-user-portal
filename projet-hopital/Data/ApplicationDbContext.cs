...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Doctor>().HasData(
            ...
            new Doctor { Id = 4, FirstName = "Manar", LastName = "Sefawi", Specialization = "Chirurgien Orthopédiste", DepartmentId = 4, ConsultationFee = 500.00m, YearsOfExperience = 18, Bio = "Expert en chirurgie osseuse et articulaire", IsAvailable = true, ImageUrl = "https://images.unsplash.com/photo-1594824476967-48c8b964273f?w=300" },
